                ...
                <div class="card" style="border-radius: 5px;">
                    <div class="card-body my-3">
                            ...
                            <div class="col-lg-9">
                                <div class="form-group">
                                    <div class='input-group date' id='datetimepicker1'>
                                        <input type='date' class="form-control" style="border: 3px solid #AAC4FF;" />
                                        </span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-9">
                                <select class="form-select" style="border: 3px solid #AAC4FF;" aria-label="Default select example">
                                    <option disabled="disabled" selected="selected">Pilih Spesialis Tujuan</option>
                                    <option value="1">Spesialis ortodonti</option>
                                    <option value="2">Spesialis bedah mulut (SpBM)Spesialis kedokteran gigi anak</option>
                                    <option value="3">Spesialis penyakit mulut</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-9">
                                <input type="text" style="border: 3px solid #AAC4FF;" class="form-control" placeholder="Masukkan No Rekam Medis Anda">
                            </div>
                        </div>
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-lg-9">
                                <input type="text" style="border: 3px solid #AAC4FF;" class="form-control" placeholder="Masukkan Keluhan Anda">
                            </div>
