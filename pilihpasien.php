...
<body style="background-color: #FDF4F5;">
    ...
    <section class="pasien" style="padding: 100px">
        <div class="direktori" style="padding: 10px 0 100px 0">
        ...
        <div class="daftar">
            <h1 class="text-center" style="color: #AAC4FF; font-weight: bold">Pilih Pasien</h1>
            <div class="kontent mt-4" style="margin-left: 180px; font-size: 23px">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card" style="border-radius: 10px; background-color: #AAC4FF; color: white; width: 80%">
                            ...
                            <div class="card-body" style="background-color: #EEF1FF; color: #AAC4FF">
                                <div class="row">
                                    <div class="col-lg-5">
                                        NIK
                                    </div>
            ...
            <div class="lanjut text-end" style="padding: 100px 145px 0 145px">
                <a href="daftarperiksa.php" class="btn btn-light" style="background-color: #AAC4FF; color: white; padding: 10px 20px 10px 20px">LANJUT</a>
            </div>
        </div>
    </section>
