...
<body style="background-color: #FDF4F5;">
    ...
    <section class="login" id="login" style="margin: 120px 0 150px 0">
        ...
        <div class="d-flex justify-content-center" style="margin-top: 50px">
            <a class="btn text-white btn-lg" href="home.php" style="background-color: #B1B2FF; width: 50%">LOGIN</a>
        </div>
        <div class="d-flex justify-content-center" style="margin-top: 10px">
            <strong class="text-center">Don't have an account?<a style="text-decoration: none" href="register.php">Create
                    One</a></strong>
        </div>
    </section>
